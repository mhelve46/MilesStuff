...
public class Wrist extends SubsystemBase {
    ...
    */
    ...
    public void rotateToVertical() {
        targetPosition = Constants.WristConstants.OldWristConstants .rotationVerticalAlligned;

        closedLoopController.setReference(Constants.WristConstants.OldWristConstants .rotationVerticalAlligned,
    ...
    public void rotateToHorizontal() {
        targetPosition = Constants.WristConstants.OldWristConstants .rotationHorizontalAlligned;

        closedLoopController.setReference(Constants.WristConstants.OldWristConstants .rotationHorizontalAlligned,
                ControlType.kMAXMotionPositionControl,
                ClosedLoopSlot.kSlot0);
