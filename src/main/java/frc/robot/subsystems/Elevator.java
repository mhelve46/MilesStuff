...
public class Elevator extends SubsystemBase {
    ...
    */
    public Elevator() {
        ...
        // elevatorLowerConfig.withSoftwareLimitSwitch(
        //         new SoftwareLimitSwitchConfigs()
        //                 .withForwardSoftLimitEnable(true)
        //                 .withForwardSoftLimitThreshold(2.5));
        elevatorLowerConfig.withFeedback(
                new FeedbackConfigs()
                        .withSensorToMechanismRatio(45));
        elevatorLowerConfig.withMotorOutput(
        ...
        elevatorUpperConfig.withCurrentLimits(
                new CurrentLimitsConfigs()
                        .withStatorCurrentLimit(Amps.of(20))
                        .withStatorCurrentLimitEnable(true));
        elevatorUpperConfig.withFeedback(
                new FeedbackConfigs()
