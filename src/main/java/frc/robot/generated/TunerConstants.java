...
public class TunerConstants {
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.25525390625);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.08105468755);
